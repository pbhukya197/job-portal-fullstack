    ...
    return (
      <div className="min-h-[calc(100vh-5rem)] bg-gradient-to-br from-gray-50 via-white to-primary-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 flex items-center justify-center px-4 py-12 relative">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-6">{!isAuthenticated ? 'You need to be logged in to view your saved jobs.' : 'This page is only available for job seekers.'}</p>
          <Link
            to="/"
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            ...
            <div className="text-right">
              <div className="text-2xl font-bold text-gray-900 dark:text-white">{savedJobs.length}</div>
              <div className="text-sm text-gray-500 dark:text-gray-400">Saved Jobs</div>
            </div>
          </div>
        </div>
        ...
        {savedJobs.length === 0 ? (
          <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-lg rounded-3xl shadow-lg border border-white/20 dark:border-gray-700/20 p-12 text-center">
            <div className="text-6xl mb-6">💾</div>
            <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">No Saved Jobs Yet</h3>
            <p className="text-gray-600 dark:text-gray-400 mb-8 max-w-md mx-auto">
              Save jobs you're interested in to easily find them later. Click the heart icon on any job listing to save it.
            </p>
            <Link
              to="/jobs"
