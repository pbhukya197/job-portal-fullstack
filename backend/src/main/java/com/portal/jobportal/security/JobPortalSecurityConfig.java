...
import com.portal.jobportal.security.filter.JwtTokenValidatorFilter;
...
//                .username("Praveen")
//                .password("$2a$10$y.M.V8Tj1iUgNnTy972VP.bIDmajkzubAL5kpKf/MMsf2BD8t7zzW") // Praveen@123
//                .roles("USER")
//                .build();
//        var user2 = User.builder()
//                .username("Admin")
//                .password("$2a$10$8SVMVffM9G5JkZAaG9Cbe.azjGhVT5DytOOcBziWo9Lmfh4/8/c2m") // Admin@123
//                .roles("ADMIN")
//                .build();
