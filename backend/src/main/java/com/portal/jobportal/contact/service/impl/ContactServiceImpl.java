package com.portal.jobportal.contact.service.impl;

import com.portal.jobportal.constants.ApplicationConstants;
import com.portal.jobportal.contact.service.IContactService;
import com.portal.jobportal.dto.ContactRequestDto;
import com.portal.jobportal.dto.ContactResponseDto;
import com.portal.jobportal.entity.Contact;
import com.portal.jobportal.repository.ContactRepository;
...
public class ContactServiceImpl implements IContactService {
    ...
    @Override
    public Page<ContactResponseDto> fetchNewContactMsgsWithPaginationAndSort(int pageNumber, int pageSize,
    ...
    private ContactResponseDto transformToDto(Contact contact) {
        ContactResponseDto contactResponseDto = new ContactResponseDto(contact.getId(), contact.getName(), contact.getEmail(),
                contact.getUserType(), contact.getSubject(), contact.getMessage(), contact.getStatus(), contact.getCreatedAt());
